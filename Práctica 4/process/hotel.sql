...
CREATE TABLE `reservahabitacion` (
  `idReserva` varchar(20) DEFAULT NULL,
  `idHabitacion` int(11) DEFAULT NULL,
  KEY `FK_reservahabitacion` (`idHabitacion`),
  KEY `FK_reservahabitacion2` (`idReserva`),
  CONSTRAINT `FK_reservahabitacion` FOREIGN KEY (`idHabitacion`) REFERENCES `habitacion` (`idHabitacion`),
  CONSTRAINT `FK_reservahabitacion2` FOREIGN KEY (`idReserva`) REFERENCES `reserva` (`idReserva`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `reservaservicio` (
  ...
  KEY `FK_reservaservicio2` (`idReserva`),
  CONSTRAINT `FK_reservaservicio` FOREIGN KEY (`idServicio`) REFERENCES `servicio` (`idServicio`),
  CONSTRAINT `FK_reservaservicio2` FOREIGN KEY (`idReserva`) REFERENCES `reserva` (`idReserva`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
