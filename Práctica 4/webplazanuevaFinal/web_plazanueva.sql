...
MySQL - 5.5.5-10.1.13-MariaDB : Database - hotel
*********************************************************************
*/
...
insert  into `habitacion`(`idHabitacion`,`tipoHabitacion`) values (1,1),(2,1),(3,1),(4,1),(5,1),(6,2),(7,2),(8,2),(9,2),(10,2),(11,2),(12,2),(13,2),(14,2),(15,2),(16,2),(17,2),(18,2),(19,2),(20,2),(21,2),(22,2),(23,2),(24,2),(25,2),(26,2),(27,2),(28,2),(29,2),(30,2),(31,2),(32,2);
...
CREATE TABLE `reserva` (
  ...
  `numBancario` varchar(255) DEFAULT NULL,
...
insert  into `reserva`(`idReserva`,`cliente`,`fechaEntrada`,`fechaSalida`,`precio`,`estado`,`numBancario`,`desayuno`) values (1,'admin','1970-01-01','1970-01-01',0,'IMBORRABLE',NULL,NULL);
...
insert  into `reservahabitacion`(`idReserva`,`idHabitacion`) values (1,1);
...
/*Data for the table `reservaservicio` */
...
insert  into `servicio`(`idServicio`,`nombre`,`descripcion`,`imgPath`,`precio`,`web`) values (1,'La Alhambra','Descubrirá con nosotros la única Ciudad Medieval Musulmana mejor conservada del mundo, la Alhambra; \r\nvisitando sus palacios, Mexuar, Comares, Leones, Generalife; paseando por sus patios, de los Arrayenes, \r\nla Reja, la Acequia, la Sultana; y disfrutando de sus jardines, de Partal, de la Medina y por suspuesto del \r\nGeneralife con sus gracioso juegos de agua, y su laberintico diseño.','images/alhambra2.jpg',12,'http://www.alhambra.org/'),(2,'Sierra Nevada','En Sierra Nevada podrá admirar la nieve y visitar numerosas estaciones de deportes de invierno \r\ncomo son Snowboard, esquí o trineos. Lo pasará genial, garantizado.','images/sierra_nevada2.jpg',90,'http://sierranevada.es/');
...
insert  into `tipohabitacion`(`idTipoHabitacion`,`nombre`,`descripcion`,`imgPath`,`precio`,`precioDesayuno`) values (1,'Doble o Twin','En nuestra habitaciones standard disfrutará de todo el equipamento y comodidad que su estancia en Granada merece.','images/hab1_grande.jpg',49,63),(2,'Doble Superior	','Disfrute de una magnífica vista de la plaza nueva y el centro de Granada desde nuestras habitaciones superiores.','images/hab2_grande.jpg',71,85),(3,'Triple	','En nuestras habitaciones triples podrá disfrutar de sus vacaciones en familia o con amigos en el centro de Granada.','images/hab3.jpg',71,85);
...
insert  into `usuario`(`nombreUsuario`,`pass`,`nombre`,`DNI`,`email`,`admin`,`direccion`,`telefono`) values ('admin','21232f297a57a5a743894a0e4a801fc3',NULL,NULL,'admin',1,NULL,NULL),('adri','5e082012573775c13199192bf00694e7','Adrián Portillo Sánchez','77397029m','adri95cadiz@hotmail.',0,'C/ Cruz del sur, bloque 6\r\n2º, letra A','654980340'),('hotel','nopass','Hotel Plaza Nueva',NULL,'info@hotel-plazanuev',0,'Imprenta, nº 2. 18010 Granada, Granada, España','+34 958 21'),('juanmyh','73a011f44d6e1fe2677523e4b28a75da',NULL,NULL,'juanmihinojosa@hotma',0,NULL,NULL);
