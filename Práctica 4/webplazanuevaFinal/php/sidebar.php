...
<body>
	...
	<div id=sidebar>
		...
		<div style="width:98%; position:relative; margin-left:2px; text-decoration:bold; color:white; background:#303030; ">
		<?php
					...
					<li>
						...
						<ul>";
                            ...
                            while ($row = mysql_fetch_assoc($result)) {
                                  if(!isset($_GET["tipo"]) || $_GET["tipo"] != $row['idTipoHabitacion'] || $_GET["seccion"] !=3 ){
                                    echo '<li><a href="index.php?seccion=3&tipo='; echo $row['idTipoHabitacion']; echo'">'; echo $row['nombre']; echo '</a></li>';
                                  }
                            }
				echo	"</ul>
					</li>
				...
				<ul>
					...
					<li>
						...
						<ul>";
                            ...
                            while ($row = mysql_fetch_assoc($result)) {
                                if(!isset($_GET["tipo"]) || $_GET["tipo"] != $row['idServicio'] || $_GET["seccion"] !=4 ){
                                echo '<li><a href="index.php?seccion=4&tipo='; echo $row['idServicio']; echo'">'; echo $row['nombre']; echo '</a></li>';
                                }
                            }
			...
			if(isset($_GET["seccion"])){
				if( $_GET["seccion"] == 3 ){
					...
					echo "<li><a href='index.php?seccion=3'>Habitaciones</a></li>";}					
                            $result = mysql_query("SELECT idTipoHabitacion, nombre FROM tipoHabitacion");
                            while ($row = mysql_fetch_assoc($result)) {
                                  if(!isset($_GET["tipo"]) || $_GET["tipo"] != $row['idTipoHabitacion'] ){
                                    echo '<li><a href="index.php?seccion=3&tipo='; echo $row['idTipoHabitacion']; echo'">'; echo $row['nombre']; echo '</a></li>';
                                  }
                            }
				}
			...
			if(isset($_GET["seccion"])){
				if( $_GET["seccion"] == 4 ){
					...
					echo "<li><a href='index.php?seccion=4'>Servicios</a></li>";}					
                            $result = mysql_query("SELECT idServicio, nombre FROM servicio");
                            while ($row = mysql_fetch_assoc($result)) {
                                if(!isset($_GET["tipo"]) || $_GET["tipo"] != $row['idServicio'] ){
                                echo '<li><a href="index.php?seccion=4&tipo='; echo $row['idServicio']; echo'">'; echo $row['nombre']; echo '</a></li>';
                                }
                            }
                            mysql_free_result($result);
	...
	<div id="ninja-slider">
        <div class="slider-inner">
            <ul>
                <li>
                   <a href='index.php?seccion=1'><img class="ns-img" src="images/promocion01.jpg"></img></a>
                    <div class="caption"></div>
                </li>
               <li><a href='index.php?seccion=1'><img class="ns-img" src="images/promocion02.png"></img></a>
                    <div class="caption"></div>
                </li>
                <li><a href='index.php?seccion=5'><img class="ns-img" src="images/promocion03.jpg"></img></a>
                    <div class="caption"></div>
                </li>
            </ul>
        </div>
